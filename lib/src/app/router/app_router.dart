...
import 'package:nostrrdr/src/app/router/adaptive_route.dart';
import 'package:nostrrdr/src/features/auth/presentation/screen/auth_screen.dart';
import 'package:nostrrdr/src/features/home/presentation/screen/filter_screen.dart';
        ...
        AutoRoute(
          ...
          children: [
            ...
            CustomRoute(
              ...
              customRouteBuilder:
                  AdaptiveRouteFactory.provideBottomSheetOrDialogRoute,
            ),
          ],
        ),
      ],
